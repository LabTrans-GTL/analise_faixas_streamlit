...
@st.cache_data
def carregar_dados():
    aeroporto_pax = pl.read_parquet("../Resultados/faixas_aeroportos.parquet")

    voos_aeroporto_aeronave = pl.read_parquet("../Resultados/voos_por_aeronave_aeroporto_trimestre3.parquet")
